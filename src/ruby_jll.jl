...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ruby_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3ea333e9-fd8a-53ca-adba-366e8551b7d5"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ruby", artifacts_toml) for e in artifacts["ruby"]]
...
if best_platform === nothing
    @debug("Unable to load ruby; unsupported platform $(triplet(platform_key_abi()))")
else
